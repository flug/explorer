  ...
  <footer class="max-w-2xl mx-auto px-5 md:px-10 py-8 text-theme-text-tertiary flex flex-col lg:flex-row flex-wrap justify-between items-center">
    <div class="mb-4 lg:mb-0 text-center md:text-left">
      ...
      <span class="block md:inline-block mb-4 md:mb-0 text-center">&copy; <a
        ...
        target="_blank"
      >Foundation.ki</a> | {{ year }}. {{ $t("All rights reserved") }}</span> <div class="block md:inline-block">
        <span class="hidden md:inline-block"> | </span> <span>{{ $t("Version") }}: <a
          :href="versionLink"
          target="_blank"
        >0.1.0</a> | {{ $t("Date") }}: {{ date }}</span>
      </div>
    </div>
    <div class="text-center">
      ...
      <a
        href="https://twitter.com/Ki_Foundation"
        target="_blank"
      >
        <svg
          viewBox="0 0 24 24"
      ...
      <a
        href="https://www.reddit.com/user/Ki_Foundation"
        target="_blank"
      >
        <svg
          viewBox="0 0 17 17"
      ...
      <a
        href="https://github.com/KiFoundation"
        target="_blank"
      >
        <svg
          viewBox="0 0 24 24"
      ...
      <a
        href="https://www.linkedin.com/company/27222045/admin/"
        target="_blank"
      >
        <svg
          class="m-2"
      ...
      <a
        href="https://medium.com/@ki_foundation"
        target="_blank"
      >
        <svg
          viewBox="0 0 24 24"
