<template>
    ...
    >
      <router-link
        :to="{ name: 'home' }"
        class="logo-container w-50px md:w-80px h-50px md:h-80px flex-none text-2xl xl:rounded-l-md flex justify-center items-center bg-blue" style="background: #ffffff;">
