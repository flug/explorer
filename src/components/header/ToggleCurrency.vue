<template>
  <button
    ...
    class="px-2 md:px-4 py-3 md:py-6 flex items-center text-sm border-b-2 margin-t-2 border-transparent hover:border-red transition genki-border-blue">
    ...
    <span class="whitespace-no-wrap text-theme-text-content hidden md:inline-block">
      ...
      XKI/{{ currencyName }}: {{ rawCurrency(currencyRate, currencyName) }}
    </span>
  </button>
</template>
