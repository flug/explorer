<template>
  <div class="w-full flex">
    <div class="px-4 md:px-8 flex-auto flex">
      <button
        :class="[
          menuVisible ? 'ki-border' : 'border-transparent',
          'px-2 sm:px-4 py-3 md:py-6 flex-none flex items-center border-b-2 margin-t-2 ki-border text-theme-text-secondary transition'
        ]"
